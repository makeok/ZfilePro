...
public class ProxyDownloadController {
    ...
    @ResponseBody
    public ResponseEntity<org.springframework.core.io.Resource> downAttachment(@PathVariable("storageKey") String storageKey, String signature, Boolean thumbnail) throws IOException {
        // 获取下载文件路径
        ...
        return proxyDownloadService.downloadToStream(filePath, thumbnail);
    }
