...
public abstract class AbstractBaseFileService<P extends IStorageParam> implements BaseFileService {
    ...
    @Override
    public void initThumbnail(String path, Boolean includeChildDir) {
        return;
    }
    ...
    @Override
    public boolean arrangeFolderByTime(String path, String formatStr) throws Exception {
        return false;
    }
    @Override
    public boolean arrangeFolderByAddress(String path, String format) throws Exception {
        return false;
    }
    @Override
