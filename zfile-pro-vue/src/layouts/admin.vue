  ...
  <Disclosure as="nav" class="bg-white shadow" v-slot="{ open }">
      ...
      <div class="relative flex justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center md:items-stretch md:justify-start">
          <el-popover
            ...
            <template #reference>
              <div @click="router.push('/')" class="cursor-pointer flex-shrink-0 flex items-center">
          ...
          <div class="hidden lg:ml-6 md:flex md:space-x-4 justify-center flex-1 lg:flex-none">
            ...
            <router-link to="/admin/view-user"
                         :class="currentActive === '/admin/view-user' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'"
                         class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              <el-icon size="18px">
          ...
          <Menu as="div" class="ml-3 relative">
            ...
            <transition enter-active-class="transition ease-out duration-200"
              ...
              <MenuItems
                ...
                <MenuItem v-slot="{ active }">
                  <router-link to="/user/update-password"
                               :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">
                    修改密码
                  </router-link>
                </MenuItem>
    ...
    <DisclosurePanel class="md:hidden">
      <div class="pt-2 pb-4 space-y-1">
        ...
        <DisclosureButton
          :class="currentActive.startsWith('/admin/user') ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'"
          as="a" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
          <router-link to="/admin/view-user">用户设置</router-link>
        </DisclosureButton>
        <DisclosureButton
