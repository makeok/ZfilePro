                      ...
                      <span>更多</span>
							...
							<template #dropdown>
								<el-dropdown-menu>
									...
									<el-dropdown-item :icon="Key" :command="{operator: '3-9', storage}">密码设置</el-dropdown-item>
									<el-dropdown-item :icon="User" :command="{operator: 'authManager', storage}">授权管理</el-dropdown-item>
									<div class="divider"></div>
...
<script setup>
import {Search, Delete, Edit, Key, Lock, VideoPause, VideoPlay, View, Document, Plus, MoreFilled, CopyDocument, User} from '@element-plus/icons-vue'
